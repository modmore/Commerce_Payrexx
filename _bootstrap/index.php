...
if (!createObject('modNamespace',array(
    'name' => 'commerce_payrexx',
    'path' => $componentPath.'/core/components/commerce_payrexx/',
    'assets_path' => $componentPath.'/assets/components/commerce_payrexx/',
),'name', false)) {
    echo "Error creating namespace commerce_payrexx.\n";
}

/* Path settings */
if (!createObject('modSystemSetting', array(
    'key' => 'commerce_payrexx.core_path',
    'value' => $componentPath.'/core/components/commerce_payrexx/',
    'xtype' => 'textfield',
    'namespace' => 'commerce_payrexx',
    'area' => 'Paths',
    'editedon' => time(),
), 'key', false)) {
    echo "Error creating commerce_payrexx.core_path setting.\n";
}

if (!createObject('modSystemSetting', array(
    'key' => 'commerce_payrexx.assets_path',
    'value' => $componentPath.'/assets/components/commerce_payrexx/',
    'xtype' => 'textfield',
    'namespace' => 'commerce_payrexx',
    'area' => 'Paths',
    'editedon' => time(),
), 'key', false)) {
    echo "Error creating commerce_payrexx.assets_path setting.\n";
}
...
$assetsUrl = "{$requestUri}assets/components/commerce_payrexx/";

if (!createObject('modSystemSetting', array(
    'key' => 'commerce_payrexx.assets_url',
    'value' => $assetsUrl,
    'xtype' => 'textfield',
    'namespace' => 'commerce_payrexx',
    'area' => 'Paths',
    ...
    echo "Error creating commerce_payrexx.assets_url setting.\n";
}
...
include $componentPath . '/core/components/commerce_payrexx/vendor/autoload.php';

// Grab the path to our namespaced files
$modulePath = $componentPath . '/core/components/commerce_payrexx/src/Modules/';
